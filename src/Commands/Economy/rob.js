...
module.exports = {
    ...
    async execute(client, arg, M) {
        ...
        if ((senderCradits - 500) < 0) return M.reply('*You Need To Have 500 Gold Or More To Rob Someone*')
        if ((mentionCradits - 500) < 0) return M.reply('*The User Dosent Have Much Money In There wallet*')
