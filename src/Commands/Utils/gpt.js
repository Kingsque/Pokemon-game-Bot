module.exports = {
    ...
    async execute(client, arg, M) {
        ...
        if (
            arg === 'who made you' || arg === 'who is your creator' ||
        ...
        try {
            ...
            if (
                arg === 'hey' || arg === 'hey, how are you' ||
                arg === 'hey how are you' || arg === 'hey how are you gpt' ||
                arg === 'hey gpt' || arg === 'hey, how are you gpt'
            ) {
                return await client.sendMessage(
                    M.from,
                    { image: { url: url }, caption: `Hey! ${(await client.contact.getContact(M.sender, client)).username} how can i help you today.` },
                    { quoted: M }
                );
            } else {
